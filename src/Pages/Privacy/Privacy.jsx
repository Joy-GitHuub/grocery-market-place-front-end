...
const Privacy = () => {
    return (
        <div>
            ...
            <div className="text_container_part">

                <div className="_content">
                    <h1>Who we are</h1>
                    <p><strong>Suggested Text:</strong> Our website address https://www.ninethem.com</p>
                </div>
                ...
                <div className="_content">
                    ...
                    <p>An anonymized string create from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p>
                </div>
